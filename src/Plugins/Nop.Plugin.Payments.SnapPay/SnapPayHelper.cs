...
namespace Nop.Plugin.Payments.SnapPay
{
    ...
    public class SnapPayHelper
    {
        ...
        /// <summary>
        /// Get the generic attribute name that is used to store an order total that actually sent to SnapPay (used to PDT order total validation)
        /// </summary>
        public static string OrderTotalSentToSnapPay => "OrderTotalSentToSnapPay";

...
namespace Nop.Plugin.Shipping.Rush
{
    ...
    /// </summary>
    public class RushShipmentTracker : IShipmentTracker
    {
        #region Fields
        ...
        public RushShipmentTracker(RushService rushService)
        {
        ...
        public virtual bool IsMatch(string trackingNumber)
        {
            ...
            //details on https://www.rush.com/us/en/tracking/help/tracking/tnh.page
        ...
        {
            return $"https://www.rush.com/track?&tracknum={trackingNumber}";
        }
        ...
        public virtual IList<ShipmentStatusEvent> GetShipmentEvents(string trackingNumber)
        {
            ...
            result.AddRange(_rushService.GetShipmentEvents(trackingNumber));
